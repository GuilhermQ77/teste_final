...
<h2>Todos os cursos diferente de informática</h2>
@foreach($cursos_info as $curso)
<p>{{ $curso->nome }}</p>
@endforeach
<h2>Todos os cursos com administração ou gestão </h2>
@foreach($cursos_tipo as $curso)
<p>{{ $curso->nome }}</p>
@endforeach
@endsection